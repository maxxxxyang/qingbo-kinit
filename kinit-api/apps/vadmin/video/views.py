...
#    视频稿件管理
###########################################################
@app.get("/articles", summary="获取视频稿件列表", tags=["视频稿件管理"])
...
@app.post("/articles", summary="创建视频稿件", tags=["视频稿件管理"])
...
@app.delete("/articles", summary="删除视频稿件", description="硬删除", tags=["视频稿件管理"])
...
@app.put("/articles/{data_id}", summary="更新视频稿件", tags=["视频稿件管理"])
...
@app.get("/articles/{data_id}", summary="获取视频稿件信息", tags=["视频稿件管理"])
